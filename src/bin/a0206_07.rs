use marsaglia_rs::kolm::{kolm2_as,kolm2_del2};
...
fn k2() {
    //const n1: usize = 12;
    //const n2: usize = 16;
    //const nrpt: usize = 1_000_000;
    let mut graphs = vec![];
    for (n1,n2,nrpt) in [(12,16,1_000_000),(1,2,1_000_000),(3,5,1_000_000),(6,8,1_000_000),(1,2,100)] {
        let mut dat1 = vec![0.0f64;n1];
        let mut dat2 = vec![0.0f64;n2];
        let mut del = vec![0.0f64;nrpt+1];
        let distribution = 0;
        println!("{} random numbers.", match distribution {
            1=> "Cauchy",
            2=> "Gauss",
            _=> "Uniform",
        });
